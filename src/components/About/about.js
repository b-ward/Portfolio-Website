            ...
            <div className="about">
                ...
                <CardDeck style={{margin: '2rem 8vw 2rem 8vw'}}>
                    ...
                    <SharedCard 
                        ...
                        After I found this tool and set up a quick website to make sure everything worked as I wanted, I got to work on setting up a GitHub repo and React project that would house my little website. I'm not particularly design-savvy so I found a tutorial that I wanted to base my design off (<a href="https://www.youtube.com/watch?v=n8iA18R76jk">https://www.youtube.com/watch?v=n8iA18R76jk</a>), but didn't really follow the coding done behind as I wanted to try and do as much as I could myself.
                        I also utilised this tutorial to design and implement the side drawer you'll find on every page: <a href="https://www.youtube.com/watch?v=l6nmysZKHFU">https://www.youtube.com/watch?v=l6nmysZKHFU</a>. Other than that I've tried to develop everything myself (with some help from stack overflow - as all developers do). You can check out my GitHub repo for this website here: <a href="https://github.com/b-ward/Portfolio-Website">https://github.com/b-ward/Portfolio-Website</a>
                        </div>}
                    />
                </CardDeck>
            </div>
